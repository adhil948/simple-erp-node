...
import {
  Box, Paper, Typography, TextField, Button, Table, TableHead, TableRow, TableCell,
  TableBody, Snackbar, TableContainer, InputLabel, FormControl, Select, MenuItem
} from '@mui/material';
    ...
    <Box sx={{ mt: 4 }}>
      <div className="container">
        <Paper sx={{ p: 3, mb: 4 }} elevation={3}>
          ...
          {showForm && (
            <Box component="form" onSubmit={handleSubmit} sx={{ display: 'flex', flexDirection: 'column', gap: 2, maxWidth: 1100 }}>
